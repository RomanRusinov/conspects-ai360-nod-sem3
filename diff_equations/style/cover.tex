...
\definecolor{DiffEqColor}{HTML}{102A3E}    % дифференциальные уравнения
...
% -----------------------------------------------------------------
\newcommand{\coverheader}{СПбГУ \ $\cdot$ \ МКН \ $\cdot$ \ НОД/AI360 \ $\cdot$ \ 2 КУРС}
...
\newcommand{\makecover}[4]{%
	...
	\begin{titlepage}
		...
		\begin{tikzpicture}[remember picture, overlay]
			...
			at ($(current page.west)+(2cm,-1.6cm)$) {%
...
\newcommand{\makestaffandcontents}{%
	...
	% --- ведущие роли ---
	\begin{center}
		\leadperson{Роман Русинов}{github-login}{координация проекта, техническая редакция, вёрстка}
		\hspace{0.05\textwidth}
		\leadperson{Ярослав Власов}{github-login}{стили, идейный вдохновитель}
		\hspace{0.05\textwidth}
		\leadperson{Роман Девятериков}{github-login}{конспекты лекций}
	\end{center}
