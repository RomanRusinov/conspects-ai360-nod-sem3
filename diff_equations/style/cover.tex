...
\newcommand{\makestaffandcontents}{%
	...
	% --- ведущие роли ---
	\begin{center}
		\leadperson{Роман Русинов}{RomanRusinov}{координация проекта, техническая редакция, вёрстка}
		\hspace{0.05\textwidth}
		\leadperson{Ярослав Власов}{yarosvla}{стили, идейный вдохновитель}
		\hspace{0.05\textwidth}
		\leadperson{Роман Девятериков}{C0ntrolDev}{конспекты лекций}
	\end{center}
