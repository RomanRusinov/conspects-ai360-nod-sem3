...
\begin{Statement}{Пример утверждения}{demo-stmt}
	Формулировка, на которую можно сослаться.
\end{Statement}

\begin{proof}
	Окружение \verb|proof| — без рамки: «\textbf{Доказательство.}» жирным
	в подбор, $\blacksquare$ в конце ставится автоматически.
	Заголовок всегда один и тот же: доказательство идёт сразу за своим
	утверждением, уточнять нечего.
\end{proof}
